const BASE_URL_IP_100 = "http://192.168.2.57:3001"
...
export const API_ENDPOINTS = {
  ...
  GET_LEAVE_SUMMARY: (employeeId: string) => `${BASE_URL_IP_100}/api/leave/summary/${employeeId}`,
  ...
  OT_CONFIG: `${BASE_URL_IP_100}/api/ot/config`,
